...
<style>
  ...
  :root {
    ...
    --cor_de_fundo_landingnew: <?= get_field('cor_de_fundo_landingnew') ?>;
    --cor_de_fundo_landingnew-light: color-mix(in srgb, var(--cor_de_fundo_landingnew), white 20%);
    --cor_de_fundo_landingnew-dark: color-mix(in srgb, var(--cor_de_fundo_landingnew), black 20%);

    --cor_de_botao_landingnew: <?= get_field('cor_de_botao_landingnew') ?>;
    --cor_de_botao_landingnew-light: color-mix(in srgb, var(--cor_de_botao_landingnew), white 20%);
    --cor_de_botao_landingnew-dark: color-mix(in srgb, var(--cor_de_botao_landingnew), black 20%);

    --cor_de_icones_landingnew: <?= get_field('cor_de_icones_landingnew') ?>;
    --cor_de_icones_landingnew-light: color-mix(in srgb, var(--cor_de_icones_landingnew), white 20%);
    --cor_de_icones_landingnew-dark: color-mix(in srgb, var(--cor_de_icones_landingnew), black 20%);

  }
  body::-webkit-scrollbar-thumb {
    background-color: var(--cor_de_fundo_landingnew);
  }
  .landing {
    background-color: var(--cor_de_fundo_landingnew);
  }
  .landing .btnBudgets {
    background-color: var(--cor_de_botao_landingnew);
    border: 1px solid var(--cor_de_botao_landingnew);
  }
  ...
  .landing .site-medic h2 .icon {
    fill: var(--cor_de_icones_landingnew);
  }
  .landing .site-medic h1 {
    color: var(--primary-color);
  }
  .landing .site-medic .grid .item {
    background-color: var(--cor_de_fundo_landingnew-light);
  }
  .landing .site-medic .grid .item p {
    color: var(--primary-color);
  }
  .landing .site-medic .grid .item p a {
    color: var(--cor_de_botao_landingnew);
  }
  .landing .site-medic .grid .item p a:hover {
    color: var(--cor_de_botao_landingnew-dark);
  }
  ...
  .landing .pros-cons p a {
    color: var(--cor_de_botao_landingnew);
  }
  .landing .pros-cons p a:hover {
    color: var(--cor_de_botao_landingnew-dark);
  }
  ...
  .landing .more-patients form label select,
  .landing .more-patients form label input {
    background-color: var(--primary-color);
    border-color: var(--cor_de_fundo_landingnew-light);
    color: var(--cor_de_fundo_landingnew);
  }
  ...
  .landing .land-faq .grid .cols .item h3 .icon {
    stroke: var(--cor_de_icones_landingnew);
    fill: transparent;
  }
  ...
  .landing .box-text p a:hover {
    color: var(--primary-color);
    text-decoration: underline;
  }

  .landing .other-pages .box-slide-page .slick-dots li.slick-active button {
    background: var(--cor_de_icones_landingnew);
  }
</style>
<div id="loader-layer">
  <?php
