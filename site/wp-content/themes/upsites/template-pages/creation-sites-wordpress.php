<?php
/*
Template Name: Criação de Sites WordPress
          ...
          <div class="item">
            <?php 
              if(get_field('subtitulo_porthome')) {
                echo '<h3 class="subtitle" data-scroll-reveal="enter bottom move 50px over 0.6s after 0s">' . get_field('subtitulo_porthome') . '</h3>';
              }
              ...
              if(get_field('texto_apoio_porthome')) {
                echo '<div data-scroll-reveal="enter bottom move 50px over 0.6s after 0s" class="tag">' . get_field('texto_apoio_porthome') . '</div>';
              }
            ?>
          </div>
          <div class="item">
          <a data-scroll-reveal="enter bottom move 50px over 0.6s after 0s" rel="dofollow" href="<?= get_permalink( get_page_by_path( 'portfolio' ) ) ?>" class="seeMore">
            <svg class="icon">
            ...
            <div class="box">
              <?php 
                ...
                if(get_field('texto_botao_func')) {
                  echo '<a data-scroll-reveal="enter bottom move 50px over 0.6s after 0s" rel="nofollow" target="_blank" href="' . get_field('link_botao_func') . '" class="btnBudgets"><svg class="icon"><use xlink:href="' . get_template_directory_uri() . '/assets/img/icons.svg#ray"></use></svg> ' . get_field('texto_botao_func') . '</a>';
                }
              ?>
            </div>
          </div>
        ...
        <div class="grid">
          <div class="text">
            ...
            if(get_field('texto_botao_fullcontrol')) {
                echo '<a data-scroll-reveal="enter bottom move 50px over 0.6s after 0s" rel="nofollow" target="_blank" href="' . get_field('link_botao_fullcontrol') . '" class="btnBudgets"><svg class="icon"><use xlink:href="' . get_template_directory_uri() . '/assets/img/icons.svg#ray"></use></svg> ' . get_field('texto_botao_fullcontrol') . '</a>';
              }
            ?>
          </div>
          <div class="image">
